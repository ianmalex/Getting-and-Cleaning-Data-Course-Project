...
sub_test <- read.table("~/test/subject_test.txt", quote="\"", comment.char="")
...
sub_train <- read.table("~/train/subject_train.txt", quote="\"", comment.char="")
...
write.table(tidymean, "~/tidymeans.txt", row.name=FALSE)
